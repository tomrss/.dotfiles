...
** Trick for removing annoying startup message
...
Use builtin winner mode to restore window setup if needed.
...
Add keybindings to easily resize windows.
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-M-l") 'recenter-other-window)
